...
from internal.entities.user import UserBase
...
from internal.use_cases.user_service import UserService
from internal.interfaces.user_interface import UserInterface
